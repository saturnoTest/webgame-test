...
export const loadKenneyAssets = (scene: Phaser.Scene) => {
  ...
  scene.load.image(UI_ARROW_BACK, UI_ARROW_BACK_PATH);
  scene.load.image(UI_BUTTON_SQUARE_BORDER, UI_BUTTON_SQUARE_BORDER_PATH);
  scene.load.image(UI_RECTANGLE_GRADIENT, UI_RECTANGLE_GRADIENT_PATH);
  scene.load.image(UI_RECTANGLE_GRADIENT_2, UI_RECTANGLE_GRADIENT_2_PATH);
  scene.load.image(UI_RECTANGLE_DEPTH_LINE, UI_RECTANGLE_DEPTH_LINE_PATH);
