...
export const UI_RECTANGLE_GRADIENT_2 = 'kenney-ui-rectangle-gradient-2';
...
export const UI_RECTANGLE_GRADIENT_2_PATH = `${KENNEY_BASE_PATH}/UI/rectangle_gradient2.png`;
